Aquí tienes una serie de ejercicios de lógica utilizando condicionales en JavaScript, organizados de principiantes a avanzado:
Nivel Principiante
...
numeros.forEach(n => console.log(n));                   // Itera sobre cada elemento
